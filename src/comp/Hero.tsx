...
export default function Hero() {
  return (
    <section className="h-screen flex flex-col justify-center items-center bg-[url('../public/wedding.jpg')] bg-cover bg-center relative">
      ...
      >
        <p className="text-gray-700 text-sm sm:text-lg md:text-white mb-6">
          <SplitText
        ...
        <a
          href="#contact"
          className="inline-block bg-brandGold text-brandWhite px-6 py-3 rounded-full font-semibold text-sm sm:text-base shadow-md hover:shadow-xl transition"
        >
          Book Now
        </a>
      </motion.div>
